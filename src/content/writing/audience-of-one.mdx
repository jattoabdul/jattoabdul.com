...
All of those readers are real. None of them is the most important one.
...
When I started writing the markdown files for the open-source project, I noticed something I had not before. I was writing every paragraph as if I were the only person who would read it. Not in the lazy way. Not "I know what I mean, so I will write less." In the opposite way. I was writing more, because I knew the only person who would be there to puzzle over it later was me.

The architecture file got the *why* of each backend, not just the *what*. The agents file got the explicit list of what the project is and is not. "Not a blanket `.pt` loader, not a general transformer runtime, not a training framework, not a model zoo." I knew the version of me reading this in six months would have forgotten which of those was the live debate when the file was first written. Future-me would need the boundary spelled out.

The compatibility file got the version-pinning rules and the tokenizer-subset boundary, because the boundary is what future-me would want first. Not the marketing claim. The exact line where support stops.

None of that was for an external reader. The repo had no users yet. The audience was one person, and that person had no context.
...
It is slower. The first ten things you write for an audience of one will feel slightly over-explained to present-you. They are over-explained for present-you. That is the point. Ship them anyway.
...
You ship fewer commits per week. Not many fewer. But the marginal time per artifact goes up by some percent. If your team's only metric is throughput, the discipline will feel like a tax.

The payoff is later. Year one is the worst year. Year three is when you start grepping your own old commit messages and finding the breadcrumb. Year five is when you become the only person who can answer specific questions on a system, because you wrote the answers down for yourself.
...
A flat-image export, embedded in the markdown, is uglier than the live diagram. It is also legible in nine months. The live diagram, six months from now, is a 404. Pick the legible one.
...
The audience-of-one reader is more demanding than present-you, because they have less context. But they are also the same person, eventually. Every piece of engineering writing you do is, in practice, training data for the version of you who will come back to it.

> The reviewer reads it once. Audience-of-one reads it forever.
...
Pick the longer-running reader. The reviewer reads it once. Audience-of-one reads it forever.
